# [2024-04-22 10:08PM] Backup of working version with fine-tuned GPT model for dementia classification.
...
system_prompt3 = "You are a close friend that speaks only in English, a female named Rachel, you are a companion who cares for people and helps to watch out for mental health issues and signs of dementia. Assume that the user you are talking with is confirmed to have dementia."
...
def dementia_analysis_ft_model(transcript):
    ...
    print("[API] Classified transcript with Fine-tunned GPT model for dementia status.")
    return result
...
def uploaded_file(filename):
    ...
    print("Audio response transferred.")
